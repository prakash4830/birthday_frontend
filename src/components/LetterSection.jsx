...
export default function LetterSection({ onNext }) {
  ...
  const letterContent = [
    ...
    {
      type: 'para',
      text: "சஞ்சனா, உன்னிடம் ஓர் கேள்வி, நான் பேசாமல் இருந்த தருணத்தில், நீ ஏன் என்னிடம் பேச முயற்சி செய்ய வில்லை?"
    },
    {
      type: 'para',
    ...
    {
      type: 'para',
      text: "அதன் பிறகு நாம் மீண்டும் சந்தித்தோம், பெசந்த் நகர் கடற்கரையில். உனக்கு ஞாபகம் இருக்கானு தெரியல சஞ்சனா, நாம் இருவரும் ஒரே நிறத்தில் உடை அணிந்திருந்தோம் தற்செயலாக். அதை உன்னிடம் கூறலாம் என்று நினைத்தேன், ஆனால் என்னால் முடியவில்லை. இதோ அந்த தருணத்தில் நான் இருந்த நிலைமை."
    },
    {
      type: 'quote',
