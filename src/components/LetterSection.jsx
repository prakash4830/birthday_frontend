...
export default function LetterSection({ onNext, onBack }) {
  ...
  const letterContent = [
    ...
    {
      type: 'para',
      text: "நாம் முதல் முதலில் சென்னை மத்திய ரயில் நிலையத்தில் சந்தித்தோம், நான் அத்தருணத்தில் மிகதாமதமாக வந்தேன் இருப்பினும் நீ எனக்கு முன்னதாக வந்து காத்துக்கொண்டிருந்தாய். நான் அதர்க்கு மிகவும் வருந்தினேன் உன்னை காக்கவைத்ததற்கு."
    },
    {
      type: 'para',
